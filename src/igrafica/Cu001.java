...
public class Cu001 extends JFrame {
	...
	public Cu001() {
		...
		lblRegistrodeUsuario.setBounds(305, 52, 233, 14);
		lblRegistrodeUsuario.setFont(new Font("Arial",Font.BOLD,18));
		contentPane.add(lblRegistrodeUsuario);
		
		JLabel lblEmail = new JLabel("Email");
		lblEmail.setBounds(63, 111, 46, 14);
		contentPane.add(lblEmail);
		
		JLabel lblContrasea = new JLabel("Contrase\u00F1a");
		lblContrasea.setBounds(63, 142, 64, 14);
		contentPane.add(lblContrasea);
		
		JLabel lblRepetirContrasea = new JLabel("Repetir Contrase\u00F1a");
		lblRepetirContrasea.setBounds(63, 167, 107, 14);
		...
		email.setBounds(167, 108, 169, 20);
		contentPane.add(email);
		email.setColumns(10);
		
		contrasena = new JTextField();
		contrasena.setBounds(167, 139, 169, 20);
		contentPane.add(contrasena);
		contrasena.setColumns(10);
		
		repetirContrasena = new JTextField();
		repetirContrasena.setBounds(167, 164, 169, 20);
		...
		btnRegistrarse.setBounds(424, 501, 114, 23);
